...
const TILE_BASE =
  "relative flex min-h-40 cursor-pointer flex-col items-center justify-center gap-3 overflow-hidden rounded-3xl border-2 px-6 py-7 text-center outline-none backdrop-blur-md transition duration-200 before:pointer-events-none before:absolute before:inset-[-50%] before:z-0 before:rotate-45 before:bg-[linear-gradient(45deg,transparent_30%,rgba(255,255,255,0.1)_50%,transparent_70%)] hover:-translate-y-0.5 active:scale-[0.99] landscape:flex-1 [&>*]:relative [&>*]:z-10";
...
export const HomeActionCards = ({
  ...
  return (
    <div className="flex w-full flex-col items-center gap-6">
      <div className="flex w-full flex-col gap-6 landscape:h-[42vh] landscape:flex-row landscape:items-stretch">
        <button
          type="button"
      ...
      <button
        type="button"
        className="pt-8 text-xl font-semibold cursor-pointer tracking-wide text-white/85 underline-offset-8 outline-none hover:text-white hover:underline focus-visible:text-white focus-visible:underline landscape:text-2xl"
